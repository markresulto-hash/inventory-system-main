...
<div class="card">
<form action="../api/add_stock.php" method="POST">
...
<input
    ...
    name="note"
    class="note-input"
    placeholder="Donation / Purchase / etc"
>

<label>Expiry Date (Optional)</label>
<input type="date" name="expiry_date" style="width:200px;">
...
<?php else: ?>
<tr>
<td colspan="4">No stock-in records yet.</td>
</tr>
<?php endif; ?>
